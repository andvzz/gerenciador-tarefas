...
<div id="create-modal" class="kb-modal" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="create-modal-title">
    ...
    <div class="kb-modal-panel">
        ...
        <div class="kb-modal-body">
            <div class="space-y-1 mb-7 pr-10">
                <h2 id="create-modal-title" class="text-2xl md:text-3xl font-black tracking-tighter uppercase text-ink">
                    Nova <span class="text-brand-600">Tarefa</span>
                </h2>
                <p id="create-modal-subtitle" class="text-sm font-medium text-brand-900/50">Crie uma nova atividade para o projeto.</p>
            </div>

            <div id="create-form-errors" class="mb-6 rounded-2xl border border-red-200 bg-red-50/80 px-5 py-4 hidden">
            ...
            <form id="create-form" class="flex flex-col gap-6" action="<?= site_url('tasks/store') ?>" method="post" data-mode="create">
                <?= csrf_field() ?>

                <div class="flex flex-col gap-2">
                    <label for="create-title" class="text-[11px] font-black uppercase tracking-[0.15em] text-brand-900/60 px-1">Título</label>
                ...
                <div class="flex flex-col gap-2">
                    <label for="create-description" class="text-[11px] font-black uppercase tracking-[0.15em] text-brand-900/60 px-1">Descrição <span class="text-brand-900/30 normal-case tracking-normal font-semibold">(opcional)</span></label>
                ...
                <div class="flex flex-col gap-2">
                    <span id="create-status-label" class="text-[11px] font-black uppercase tracking-[0.15em] text-brand-900/60 px-1">Status</span>

                    <input type="hidden" id="create-status" name="status" value="pendente">

                    <div id="create-status-select" class="kb-select" data-open="false">
                        <button type="button" id="create-status-trigger" class="kb-select-trigger"
                                aria-haspopup="listbox" aria-expanded="false" aria-labelledby="create-status-label">
                            <span id="create-status-dot" class="kb-select-dot" style="background: <?= $coresStatus['pendente'] ?>;"></span>
                            <span id="create-status-value" class="kb-select-value">Pendente</span>
                        ...
                        <ul id="create-status-list" class="kb-select-list" role="listbox" aria-labelledby="create-status-label">
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <button type="submit" id="create-form-submit"
                        ...
                        <span id="create-form-submit-label">Salvar Tarefa</span>
                    </button>
                </div>
            </form>
        </div>
